...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("ZMovieClip", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("ZMovieClip", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "ZMovieClip";
		app.meta["name"] = "ZMovieClip";
		app.meta["packageName"] = "com.sample.zmovieclip";
